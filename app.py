...
# ---------------- Page Config ----------------
st.set_page_config(page_title="રક્ષા શક્તિ સ્કૂલ જીરા વિશ્લેષણ", page_icon="🏫")
st.title("🏫 રક્ષા શક્તિ સ્કૂલ જીરામાંથી  બાળકોને લખી અપેલ ૩૦ થી ૪૦ મુદ્દાનું વિશ્લેષણ")
